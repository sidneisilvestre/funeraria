...
<link rel="stylesheet" href="css/style.css" />
    <title>Edição de Cadastro dos atendimentos</title>
  </head>
  <body>
  <h1 id="conteudo">Edição de Cadastro de atendimentos</h1>
  <h2>Cadastre aqui as despesas geradas pelo evento que você atendeu </h2>
<form action="http://funeraria.offline/atendimentos" method="post">
@csrf
@method("put")
...
<input type="number" name="km" id="km" class="form-control" value="{{ $atendimento->km }}"/>
</div>

<div class="form-group">
<label for="ali">Inclua o total de despesas com alimentação</label>
<input name="ali" id="ali" type="number" class="form-control" value="{{ $atendimento->ali }}"/>
</div>

<div class="form-group">
<label for="ped">Inclua o total de despesas com pedágio </label>
<input name="ped" id="ped" type="number" class="form-control" value="{{ $atendimento->ped }}"/>
</div>


<div class="form-group">
<label for="combu"> Inclua o total de despesas com combustível </label>
<input type="number" name="combu" id="combu" class="form-control" value="{{ $atendimento->combu }}"/>
</div>

<div class="form-group">
<label for="mec"> Inclua o total de despesas com oficina mecânica </label>
<input type="number" name="mec" id="mec" class="form-control" onblu="soma()" value="{{ $atendimento->mec }}"/>
</div>


<div class="form-group">
<label for="obs"> Informe os demais ítens ou serviços que foram consumidos  durante este atendimento </label>
<input type="text" name="obs" id="obs" value="total" class="form-control" value="{{ $atendimento->obs }}"/>
</div>
<div class="form-group">
<!-- <fieldset>
