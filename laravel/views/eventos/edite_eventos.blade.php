...
<form action="http://funeraria.offline/eventos" method="post">
@csrf
<div class="form-group">
<a href="cadastro_clientes.blade.php">Caso o cliente não esteja cadastrado, Clique ou pressione enter aqui para iniciar um novo  cadastro de cliente </a>
</div>
<div class="form-group">
